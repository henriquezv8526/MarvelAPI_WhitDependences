...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "No se encontraron resultados" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Mostrando registros _START_ al _END_ de _TOTAL_ en total",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(de _MAX_ total registros)",
